...
2. **Multi-model sentiment fusion** — combines a VADER lexicon baseline with a FinBERT neural score, dynamically weighted by prediction confidence, directly addressing the challenge's request to compare sentiment methods.
