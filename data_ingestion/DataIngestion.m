...
classdef DataIngestion
    methods (Static)
        ...
        function writeSentiment(timestamp, symbol, mlScore, vaderScore, ratioRuleScore, llmScore, llmConf)
            ...
            query = "INSERT INTO sentiment_scores (timestamp, symbol, ml_score, vader_score, ratio_rule_score, llm_score, llm_confidence) " + ...
                "VALUES (?, ?, ?, ?, ?, ?, ?) " + ...
            ...
            try
                execute(conn, query, {timeStr, symbol, mlScore, vaderScore, ratioRuleScore, llmScore, llmConf});
            catch e
